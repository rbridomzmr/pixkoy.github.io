...
if(!x)x=prompt('请手动输入：关键词、作品番号、神秘代码……\n');
...
if(i==1){
  ...
  else if(i==3){y.setAttribute('src','http://fanyi.youdao.com/web2/seed.js');z;}
  else if(i==4){y.setAttribute('src','http://labs.microsofttranslator.com/bookmarklet/default.aspx?f=js&to=zh-chs');z;}
  else if(i==5){y.setAttribute('src','http://dict.hujiang.com/app/js/dict_ajax.js');z;}
  ...
  else if(i==7){y.setAttribute('src','http://www.zdic.net/tools/xzsy');z;}
  else if(i==8){y.setAttribute('src',u+'繁转简体.js');z;}
}

else if(i==4){
  i=prompt('1、视频广告　2、夜间模式　3、阅读模式　4、右键限制\n\n5、复制链接文字\n');
  if(i==1){y.setAttribute('src','http://zythum.sinaapp.com/mama2/dest/index.js');z;}
  ...
  else if(i==4){y.setAttribute('src','http://lixian.vip.xunlei.com/lxrc/js/load.js');z;}
}
  ...
  if(i==1){y.setAttribute('src','http://www.baidu.com/olime/bdime_open.js');z;}
  else if(i==2){y.setAttribute('src','http://www.printwhatyoulike.com/static/pagezipper/pagezipper_10.js');z;}
}
