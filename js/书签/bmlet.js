...
if(i==1){
  ...
  else if(i==7){style=document.createElement('style');text=document.createTextNode('.t_f a {color: #fff;background-color:#ff6699;padding:0 10px;text-decoration:none;}');style.appendChild(text);document.body.appendChild(style);}
}
  ...
  else if(i==4){window.open('https://pixkoy.github.io/pixkoy/');}
