javascript:x=''+window.getSelection();y=document.createElement('script');z=document.body.appendChild(y);u='https://pixkoy.github.io/';s='src';
...
if(i==1){
  ...
  if(i==1){
    ...
    if(i==1){window.open('https://www.google.com/search?q=site:'+location.hostname+' '+x);}
    else if(i==2){window.open('https://www.baidu.com/baidu?ct=2097152&si='+location.hostname+'&word='+x);}
    else if(i==3){window.open('https://cn.bing.com/search?q=site:'+location.hostname+' '+x);}
    else if(i==4){window.open('https://www.sogou.com/web?query=site:'+location.hostname+' '+x);}
    else if(i==5){window.open('https://www.haosou.com/s?q=site:'+location.hostname+' '+x);}
  }
  else if(i==2){
    ...
    if(i==1){window.open('https://www.google.com/search?q=cache:'+location.href);}
    else if(i==2){window.open('http://web.archive.org/web/*/'+location.href);}
  }
}

else if(i==3){
  i=prompt('1、谷歌翻译　2、百度翻译　3、有道翻译　4、必应翻译\n\n5、沪江小Ｄ　6、爱词霸　　7、汉典　　　8、繁转简体\n');
  if(i==1){if(x){window.open('https://translate.google.com/#auto/zh-CN/'+x);}else{window.open('https://translate.google.com/translate?u='+location.href);}}
  else if(i==2){window.open('http://fanyi.baidu.com/transpage?query='+location.href+'&render=1');}
  else if(i==3){y.setAttribute('src','http://fanyi.youdao.com/web2/seed.js');document.body.appendChild(x);}
  else if(i==4){y.setAttribute('src','http://labs.microsofttranslator.com/bookmarklet/default.aspx?f=js&to=zh-chs');document.body.appendChild(x);}
  else if(i==5){y.setAttribute('src','http://dict.hujiang.com/app/js/dict_ajax.js');document.body.appendChild(x);}
  ...
  else if(i==7){y.setAttribute('src','http://www.zdic.net/tools/xzsy');document.body.appendChild(x);}
  else if(i==8){y.setAttribute('src','https://pixkoy.github.io/繁转简体.js');document.body.appendChild(x);}
}
  ...
  if(i==1){
    ...
    if(i==1){window.open('https://flvgo.com/download?url='+location.href);}
    else if(i==2){window.open('http://deturl.com/'+location.href);}
    else if(i==3){
      i=prompt('1、爱哔哩　　　2、哔哩哔哩唧唧\n\n3、bilibili.audio');
      if(i==1){window.open(location.href.replace('bilibili','ibilibili'));}
      else if(i==2){window.open(location.href.replace('bilibili','bilibilijj'));}
      else if(i==3){window.open('http://bilibili.audio/'+location.href.match(/(av)([0-9]{6,8})/)[2]+'/1');}
    }
    else if(i==4){
      i=prompt('1、超簡単♪　2、10YouTube　3、SaveMedia');
      if(i==1){window.open(location.href.replace('https://www.youtube.com/watch?v=','http://youtube-video-download.info/video/'));}
      else if(i==2){window.open(location.href.replace('https://www.youtube','http://www.10youtube'));}
      else if(i==3){window.open(location.href.replace('youtube','savemedia'));}
    }
  }
  else if(i==2){
  ...
  else if(i==4){y.setAttribute('src','http://lixian.vip.xunlei.com/lxrc/js/load.js');document.body.appendChild(x);}
}

else if(i==6){
  i=prompt('1、Saved.io　　　　2、Google 书签\n\n3、Google 二维码 　4、微博短网址\n');
  if(i==1){x=prompt('请选择分类：');if(x){window.open('http://'+x+'.saved.io/'+location.href);}else{window.open('http://saved.io/'+location.href);}}
  ...
  else if(i==3){window.open('http://chart.apis.google.com/chart?cht=qr&chs=500x500&chl='+encodeURIComponent(location.href),'Qr code','top=100,left=600,width=500,height=500,status=yes');}
  else if(i==4){if(location.href.match(5786724301)){document.write('<style type="text/css">body{background:#333;color:#f69;font-family:Microsoft YaHei Light;font-size:10em;margin:0px auto;text-align:center;}</style></br>'+document.body.innerHTML.match(/(short":")(.{15,25})(",")/)[2]);}else{window.open('http://api.weibo.com/2/short_url/shorten.json?source=5786724301&url_long='+location.href);}}
}
  ...
  if(i==1){y.setAttribute('src','http://www.baidu.com/olime/bdime_open.js');document.body.appendChild(x);}
  else if(i==2){y.setAttribute('src','http://www.printwhatyoulike.com/static/pagezipper/pagezipper_10.js');document.body.appendChild(x);}
}

else if(i=='+'){
  i=prompt('1、百度、　2、Google　3、网易云音乐　4、以后更新\n');
